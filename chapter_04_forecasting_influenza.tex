...
\begin{table}[htb]
  \begin{center}
    \scalebox{0.7}{
      \input{tables/chapter_04/tables_model_summary.tex}
    }
    \caption{
...
\begin{table}[htb]
  \begin{center}
    \scalebox{0.9}{
      \input{tables/chapter_04/tables_simulated_model_selection.tex}
    }
    \caption{
...
\begin{figure}[htb]
  ...
  }{\includegraphics[width=\textwidth]{chapter_04/Figure_3-Figure_supplement_1.pdf}}\label{figsupp:unadjusted_composite_model_accuracy_and_coefficients_for_simulated_populations}
...
\begin{figure}
  ...
  \figsupp[Validation of naive model for simulated populations of H3N2-like viruses.]{
    ...
    These timepoints correspond to the closed circles in Figure~\ref{fig:cross_validation_for_simulated_populations}.
    Note that the naive model sets future frequencies to current frequencies such that there is no estimated fold change in frequencies for the first panel.}{\includegraphics[width=\textwidth]{chapter_04/Figure_4-Figure_supplement_2.pdf}}\label{figsupp:validation_of_naive_model_for_simulated_populations}
  ...
  \figsupp[Test of naive model for simulated populations of H3N2-like viruses.]{
    ...
    These timepoints correspond to the open circles in Figure~\ref{fig:cross_validation_for_simulated_populations}.
    Note that the naive model sets future frequencies to current frequencies such that there is no estimated fold change in frequencies for the first panel.}{\includegraphics[width=\textwidth]{chapter_04/Figure_4-Figure_supplement_3.pdf}}\label{figsupp:test_of_naive_model_for_simulated_populations}
...
\begin{table}[htb]
  \begin{center}
    \scalebox{0.9}{
      \input{tables/chapter_04/tables_natural_model_selection.tex}
    }
    \caption{
...
\begin{figure}[htb]
  ...
  }{\includegraphics[width=\textwidth]{chapter_04/Figure_5-Figure_supplement_1.pdf}}\label{figsupp:unadjusted_composite_model_accuracy_and_coefficients_for_natural_populations_epitope_vs_oracle}
...
\begin{figure}[htb]
  ...
  \figsupp[Composite models fit to most recent data from natural populations.]{
    ...
    The naive model's distance to the future was 6.82 $\pm$ 1.74 AAs for these timepoints.}{\includegraphics[width=\textwidth]{chapter_04/Figure_6-Figure_supplement_1.pdf}}\label{figsupp:updated_model_accuracy_and_coefficients_for_natural_populations_across_test_data}
...
\begin{figure}
  ...
  \figsupp[Validation of best model for natural populations of H3N2 viruses.]{
    ...
    C) Absolute forecast error for clades shown in A by their initial frequency with a mean LOESS fit (solid black line) and 95\% confidence intervals (gray shading) based on 100 bootstraps.
    D) The correlation of all strains at all timepoints by the percentile rank of their observed and estimated distances to the future.
    The corresponding results for the naive model are shown in Figure~\ref{fig:test_of_best_model_for_natural_populations}-Figure supplement~\ref{figsupp:validation_of_naive_model_for_natural_populations}.}{\includegraphics[width=\textwidth]{chapter_04/Figure_7-Figure_supplement_1.pdf}}\label{figsupp:validation_of_best_model_for_natural_populations}
  ...
  \figsupp[Validation of naive model for natural populations of H3N2 viruses.]{
    ...
    These timepoints correspond to the closed circles in Figure~\ref{fig:cross_validation_for_natural_populations}.
    Note that the naive model sets future frequencies to current frequencies such that there is no estimated fold change in frequencies for the first panel.}{\includegraphics[width=\textwidth]{chapter_04/Figure_7-Figure_supplement_2.pdf}}\label{figsupp:validation_of_naive_model_for_natural_populations}
  ...
  \figsupp[Test of naive model for natural populations of H3N2 viruses.]{
    ...
    These timepoints correspond to the open circles in Figure~\ref{fig:cross_validation_for_natural_populations}.
    Note that the naive model sets future frequencies to current frequencies such that there is no estimated fold change in frequencies for the first panel.}{\includegraphics[width=\textwidth]{chapter_04/Figure_7-Figure_supplement_3.pdf}}\label{figsupp:test_of_naive_model_for_natural_populations}
...
\begin{figure}[htb]
  ...
  \figsupp[Relative improvement of model selections over vaccine strains.]{
    ...
    Source data are available in Figure~\ref{fig:vaccine_comparison}-source data~\ref{figdata:vaccine_comparison}.
  }{\includegraphics[width=\textwidth]{chapter_04/Figure_8-Figure_supplement_1.pdf}}\label{figsupp:vaccine_comparison_relative_distance}
...
\begin{table}
  \begin{center}
    \input{tables/chapter_04/tables_mutations_by_trunk_status_for_simulated_populations.tex}
    \caption{
...
\begin{table}
  \begin{center}
    \input{tables/chapter_04/tables_mutations_by_trunk_status.tex}
    \caption{
...
\begin{table}[H]
  \begin{center}
    \scalebox{0.7}{
        \input{tables/chapter_04/tables_composite_vs_individual_model_comparison.tex}
    }
    \caption{
...
\begin{table}
  \begin{center}
    \scalebox{0.9}{
        \input{tables/chapter_04/tables_complete_natural_model_selection.tex}
    }
    \caption{
